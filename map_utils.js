...
function onEachFeature(feature, layer, layer_group, list, list_name, create_checkbox) {
    ...
    if (feature.geometry.type == "Point") {
        ...
        if (feature.properties.image_id) {
            ...
            layer.bindPopup("<a href='https://media.gtanet.com/gta4/images/flying-rats/" + feature.properties.image_id + ".jpg'><img src='https://media.gtanet.com/gta4/images/flying-rats/" + feature.properties.image_id + ".jpg' width='500/' /></a>" + (feature.properties.description ? feature.properties.description : ""), { maxWidth: 500 });
        }
